...
total_employed = st.slider('Total employed (in millions)', min_value= 4000.0, max_value= 17e4, value=6e5, step=1e1)
total_employed_males = st.slider('Total employed males only (in millions)', min_value= 4000.0, max_value= 17e4, value=6e5, step=1e1)
total_employed_females = st.slider('Total employed females only (in millions)', min_value= 4000.0, max_value= 17e4, value=6e5, step=1e1)
total_unemployed = st.slider('Total unemployed (in millions)', min_value= 4000.0, max_value= 17e4, value=6e5, step=1e1)
total_unemployed_males = st.slider('Total unemployed males only (in millions)', min_value= 4000.0, max_value= 17e4, value=6e5, step=1e1)
total_unemployed_females = st.slider('Total unemployed females only (in millions)', min_value= 4000.0, max_value= 17e4, value=6e5, step=1e1)
